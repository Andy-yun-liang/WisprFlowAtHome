...
const config = {
  ...
  extraResources: [
    ...
    { from: 'resources/tray-idle.png', to: 'tray-idle.png' },
    { from: 'resources/tray-recording.png', to: 'tray-recording.png' },
    { from: 'resources/tray-processing.png', to: 'tray-processing.png' },
